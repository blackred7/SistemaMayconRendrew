...
import view.controle.ControleConsutaUsu;
 ...
 * @author u13766540670
 */
public class JDLgConsutasUsuario extends javax.swing.JDialog {
    UsuarioControle controle;
    /**
     * Creates new form JDLgConsutasUsuario
     */
    public JDLgConsutasUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setTitle("consutar usuario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLgConsutasUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLgConsutasUsuario dialog = new JDLgConsutasUsuario(new javax.swing.JFrame(), true);
