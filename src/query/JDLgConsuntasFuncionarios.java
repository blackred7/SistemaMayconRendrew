 ...
 * @author User
 */
public class JDLgConsuntasFuncionarios extends javax.swing.JDialog {
ControleFuncionario controle;
    /**
     * Creates new form JDLgConsuntasFuncionarios
     */
    public JDLgConsuntasFuncionarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLgConsuntasFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLgConsuntasFuncionarios dialog = new JDLgConsuntasFuncionarios(new javax.swing.JFrame(), true);
