 ...
 * @author u13766540670
 */
public class JDLgVenda_pesquisar extends javax.swing.JDialog {
vendasControle controle;
private  JDLgVendas jDLgVendas;
    /**
     * Creates new form JDLgVenda_pesquisar
     */
    public JDLgVenda_pesquisar(java.awt.Frame parent, boolean modal) {
          super(parent, modal);
        initComponents(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLgVenda_pesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLgVenda_pesquisar dialog = new JDLgVenda_pesquisar(new javax.swing.JFrame(), true);
