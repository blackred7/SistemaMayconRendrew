...
public class JDlgAnimaisNovo extends javax.swing.JDialog {
 ...
 boolean incl;
     ...
     */
    public JDlgAnimaisNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgAnimaisNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgAnimaisNovo dialog = new JDlgAnimaisNovo(new javax.swing.JFrame(), true);
